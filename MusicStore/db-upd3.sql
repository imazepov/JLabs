...
ALTER TABLE `MusicStore`.`Article` COLLATE = utf8_general_ci , ADD COLUMN `Price` FLOAT(11) NOT NULL  AFTER `Description` ;

ALTER TABLE `MusicStore`.`Invoice` COLLATE = utf8_general_ci , CHANGE COLUMN `Submitted` `Submitted` BIT(1) NOT NULL DEFAULT False  ;
